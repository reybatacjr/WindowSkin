using WindowSkin.Controls;
using WindowSkin.Properties;
using System;
...
{
    public class WindowSkinManager
    {
        //Singleton instance
        private static WindowSkinManager _instance;

        //Forms to control
        private readonly List<WindowSkinForm> _formsToManage = new List<WindowSkinForm>();
        ...
        private static readonly Color BACKGROUND_LIGHT = Color.FromArgb(239, 244, 249);
        private static Brush BACKGROUND_LIGHT_BRUSH = new SolidBrush(BACKGROUND_LIGHT);

        private static readonly Color BACKGROUND_DARK = Color.FromArgb(32, 32, 32);
        ...
        public readonly Color ACTION_BAR_TEXT_SECONDARY = Color.FromArgb(87, 87, 88); // Color.FromArgb(153, 255, 255, 255);
        ...
        //Roboto font
        public Font CenturyGothicB_12;
        public Font CenturyGothic_11;
        public Font CenturyGothicB_11;
        public Font CenturyGothicB_10;
        ...
        private WindowSkinManager()
        {
            CenturyGothicB_12 = new Font(LoadFont(Resources.CenturyGothicB), 12f);
            CenturyGothicB_10 = new Font(LoadFont(Resources.CenturyGothicB), 10f);
            CenturyGothic_11 = new Font(LoadFont(Resources.CenturyGothic), 11f);
            CenturyGothicB_11 = new Font(LoadFont(Resources.CenturyGothicB), 11f);
            Theme = Themes.LIGHT;
            ColorScheme = new ColorScheme(Primary.BlueGrey30, Primary.BlueGrey40, Primary.BlueGrey10, Accent.LightBlue200, TextShade.BLACK, Primary.Blue900);
        }

        public static WindowSkinManager Instance => _instance ?? (_instance = new WindowSkinManager());

        public void AddFormToManage(WindowSkinForm materialForm)
        {
            _formsToManage.Add(materialForm);
            UpdateBackgrounds();
        }

        public void RemoveFormToManage(WindowSkinForm materialForm)
        {
